...
NAME = webserv
SRC_DIR = src
SRC = main.cpp Webserv.cpp Server.cpp XML/XMLDocument.cpp XML/XMLElement.cpp UUID/UUID.cpp Logger.cpp Request.cpp Response.cpp util.cpp MimeTypes.cpp Route.cpp Listener.cpp
BUILD_DIR = build
